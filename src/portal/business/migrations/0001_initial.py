...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('share', models.CharField(choices=[('shared', 'Shared Owner'), ('value', 'Value'), ('equity', 'Equity')], max_length=20)),
                ('share_equity', models.IntegerField(choices=[('shared', 'Shared Owner'), ('value', 'Value'), ('equity', 'Equity')], max_length=20)),
                ('share_value', models.FloatField(choices=[('shared', 'Shared Owner'), ('value', 'Value'), ('equity', 'Equity')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
